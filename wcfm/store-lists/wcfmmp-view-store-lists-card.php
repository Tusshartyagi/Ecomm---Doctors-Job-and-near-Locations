...
$store_name      = isset( $store_info['store_name'] ) ? esc_html( $store_info['store_name'] ) : __( 'N/A', 'matico' );
	...
	<div class="store-wrapper">
                ...
                <div class="store-data">
                    ...
                    <?php if ( apply_filters( 'wcfmmp_is_allow_checkout_user_location', true ) && apply_filters( 'wcfm_is_allow_store_list_distance', true ) ) {
                        ...
                        if( $distance ) {
                            ?>
                            <p class="store-phone">
                                <i class="wcfmfa fa-map-marker-alt" aria-hidden="true"></i> <?php echo wp_kses_post($distance . ' ' . $radius_unit . ' ' . __( 'away', 'matico' )); ?>
                            </p>
                        <?php }
                    } ?>
                    <?php if ( apply_filters( 'wcfm_is_allow_store_list_product_count', false ) ) {
                        ...
                        ?>
                        <p class="store-phone">
                            <i class="wcfmfa fa-cube" aria-hidden="true"></i> <?php echo wp_kses_post( $total_products . ' ' . __( 'products', 'matico' ) ); ?>
                        </p>
                    <?php } ?>
		...
		<div class="store-footer">
			...
			<?php if( apply_filters( 'wcfmmp_is_allow_sold_by_linked', true ) && apply_filters( 'wcfmmp_is_allow_visit_store_button', true ) ) { ?>
			  <a href="<?php echo esc_url($store_url); ?>" class="wcfmmp-visit-store"><?php _e( 'Visit <span>Store</span>', 'matico' ); ?></a>
			<?php } ?>
