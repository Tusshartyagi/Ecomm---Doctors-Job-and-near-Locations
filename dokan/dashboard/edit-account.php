    ...
    <div class="dokan-dashboard-content">
        ...
        <article class="dashboard-content-area woocommerce edit-account-wrap">
            ...
            <form class="edit-account" action="" method="post">
				...
				<p class="form-row form-row-wide">
                    <label for="superintendent_name"><?php esc_html_e( 'Superintendent Name', 'dokan-lite' ); ?> <span class="required">*</span></label>
                    <input type="text" class="input-text" name="superintendent_name" id="superintendent_name" value="<?php echo esc_attr( $superintendent_name ); ?>"/>
                </p>
