                ...
                if ( apply_filters( 'dokan_can_post', true ) ) :
                    ...
                    if ( dokan_is_seller_enabled( get_current_user_id() ) ) :
                        ...
                        <form class="dokan-form-container" method="post">
                            ...
                            <div class="dokan-form-group">
                                <label for="post_content" class="control-label"><?php esc_html_e( 'Full Description', 'dokan-lite' ); ?> <i class="fas fa-question-circle tips" data-title="<?php esc_attr_e( 'Add your product description', 'dokan-lite' ); ?>" aria-hidden="true"></i></label>
                                <?php
                                wp_editor(
