...
class SetupWizard extends DokanSetupWizard {
    ...
    public function dokan_setup_store() {
		...
		$address_street3 = isset( $store_info['address']['street_3'] ) ? $store_info['address']['street_3'] : '';
        ...
        ?>dasdasd
        <h1><?php esc_attr_e( 'Store Setup 1', 'dokan-lite' ); ?></h1>
        <form method="post" class="dokan-seller-setup-form">
            <table class="form-table">
                ...
                <tr>
                    <th scope="row"><label for="address[street_1]"><?php esc_html_e( 'Address 1', 'dokan-lite' ); ?></label></th>
                    <td>
                        <input type="text" id="address[street_1]" name="address[street_1]" value="<?php echo esc_attr( $address_street1 ); ?>"/>
                    </td>
                </tr>
                <tr>
                    <th scope="row"><label for="address[street_2]"><?php esc_html_e( 'Address 2', 'dokan-lite' ); ?></label></th>
                    <td>
                        <input type="text" id="address[street_2]" name="address[street_2]" value="<?php echo esc_attr( $address_street2 ); ?>"/>
                    </td>
                </tr>
			 <tr>
                    <th scope="row"><label for="address[street_3]"><?php esc_html_e( 'Address 3', 'dokan-lite' ); ?></label></th>
                    <td>
                        <input type="text" id="address[street_3]" name="address[street_3]" value="<?php echo esc_attr( $address_street3 ); ?>"/>
                    </td>
                </tr> 
                <tr>
